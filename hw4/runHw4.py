...
def challenge1a():
    ...
    # the y coordinates.
    xt1, yt1, xt2, yt2, xt3, yt3, xt4, yt4 = [150,150, 400,300, 200,200, 350,350]
...
def challenge1b(): 
    ...
    # Estimate homography
    bg_pts = np.array([(105, 25), (269, 75), (88, 431), (279, 417)])
    portrait_pts = np.array([(8, 9), (317, 9), (8, 391), (317, 391)])
